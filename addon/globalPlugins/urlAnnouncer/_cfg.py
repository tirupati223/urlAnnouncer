...
# Isolated here to avoid circular imports between __init__.py and settings.py
import json
import os

_PATH = os.path.join(os.environ.get("APPDATA", os.path.expanduser("~")), "nvda", "urlAnnouncer_config.json")
...
data = {
	...
	"restore_clipboard": True,    # Restore clipboard after URL read
